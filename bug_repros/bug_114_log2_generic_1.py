"""Minimal cross-library repro for bug_114 (log2/generic/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, 0.0, -19.931568145751953]]}''')
WRONG = json.loads(r'''{"chainer": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -149.0], [NaN, 0.0, -19.931568145751953]]}, "keras": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -150.0], [NaN, 0.0, -19.931568145751953]]}}''')
APIS = json.loads(r'''{"chainer": "chainer.functions.log2", "jax": "jax.numpy.log2", "keras": "keras.ops.log2"}''')
