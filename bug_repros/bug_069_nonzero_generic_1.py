"""Minimal cross-library repro for bug_069 (nonzero/generic/1)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"keras": {"dtype": "int32", "shape": [3, 2], "value": [[1, 0], [1, 1], [1, 2]]}}''')
APIS = json.loads(r'''{"keras": "keras.ops.nonzero", "numpy": "numpy.nonzero"}''')
