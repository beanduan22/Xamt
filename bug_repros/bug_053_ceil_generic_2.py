"""Minimal cross-library repro for bug_053 (ceil/generic/2)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"mxnet": {"dtype": "float32", "shape": [2, 3], "value": [[-0.0, 0.0, 1.0], [-1.0, 1.0, 1.0]]}}''')
APIS = json.loads(r'''{"mxnet": "mxnet.numpy.ceil", "tensorflow": "tensorflow.math.ceil"}''')
