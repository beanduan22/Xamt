"""Minimal cross-library repro for bug_117 (ndtri/generic/1)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"chainer": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -14.121426582336426], [NaN, Infinity, -4.753424167633057]]}}''')
APIS = json.loads(r'''{"chainer": "chainer.functions.ndtri", "jax": "jax.scipy.special.ndtri"}''')
