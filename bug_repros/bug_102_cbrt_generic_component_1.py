"""Minimal cross-library repro for bug_102 (cbrt/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["jax", "keras", "mxnet"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-0.0, 0.0, 8.881775197276188e-16], [-1.0, 1.0, 0.009999998845160007]]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[NaN, NaN, NaN], [-1.0, 1.0, 0.009999998845160007]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.cbrt", "mindspore": "mindspore.numpy.cbrt"}''')

def run_jax():
    LIB = 'jax'
    QNAME = 'jax.numpy.cbrt'
    fn = resolve(QNAME)
