"""Minimal cross-library repro for bug_182 (poly/generic/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["mxnet", "numpy"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [4], "value": [1.0, -1.401298464324817e-45, -Infinity, Infinity]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [4], "value": [1.0, 0.0, -Infinity, NaN]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.poly", "numpy": "numpy.poly"}''')
