"""Minimal cross-library repro for bug_089 (unique_values/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [5], "value": [-1.0, -0.0, 1.401298464324817e-45, 9.999999974752427e-07, 1.0]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [4], "value": [-1.0, -0.0, 9.999999974752427e-07, 1.0]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.unique_values", "numpy": "numpy.unique_values"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.unique_values'
    fn = resolve(QNAME)
