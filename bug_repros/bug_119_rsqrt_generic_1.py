"""Minimal cross-library repro for bug_119 (rsqrt/generic/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, Infinity], [NaN, 1.0, 999.9999389648438]]}''')
WRONG = json.loads(r'''{"chainer": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, 2.671373844909537e+22], [NaN, 1.0, 999.9999389648438]]}}''')
APIS = json.loads(r'''{"chainer": "chainer.functions.rsqrt", "keras": "keras.ops.rsqrt"}''')

def run_keras():
    LIB = 'keras'
    QNAME = 'keras.ops.rsqrt'
    fn = resolve(QNAME)
