"""Minimal cross-library repro for bug_149 (bessel_y1/generic)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -636619.75], [-1.4714723825454712, -0.7812128067016602, NaN]]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[NaN, -Infinity, -636619.75], [-1.4714723825454712, -0.7812128067016602, NaN]]}}''')
APIS = json.loads(r'''{"mindspore": "mindspore.ops.bessel_y1", "torch": "torch.special.bessel_y1"}''')

def run_torch():
    LIB = 'torch'
    QNAME = 'torch.special.bessel_y1'
    fn = resolve(QNAME)
