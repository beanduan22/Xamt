"""Minimal cross-library repro for bug_101 (cbrt/generic/2)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["jax", "mxnet"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-0.0, 0.0, 8.881775197276188e-16], [-1.0, 1.0, 0.009999998845160007]]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[NaN, NaN, 1.1190335437051406e-15], [-1.0, 1.0, 0.009999998845160007]]}}''')
APIS = json.loads(r'''{"jax": "jax.lax.cbrt", "mindspore": "mindspore.numpy.cbrt"}''')
