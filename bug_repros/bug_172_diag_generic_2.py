"""Minimal cross-library repro for bug_172 (diag/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2], "value": [1.0, 2.0]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [2], "value": [NaN, 2.0]}}''')
APIS = json.loads(r'''{"mindspore": "mindspore.numpy.diag", "numpy": "numpy.diag"}''')
