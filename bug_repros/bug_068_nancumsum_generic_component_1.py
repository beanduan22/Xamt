"""Minimal cross-library repro for bug_068 (nancumsum/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [6], "value": [0.0, Infinity, NaN, NaN, NaN, NaN]}''')
WRONG = json.loads(r'''{"keras": {"dtype": "float32", "shape": [6], "value": [0.0, 3.4028234663852886e+38, 0.0, -1.0, 0.0, 9.999999974752427e-07]}}''')
APIS = json.loads(r'''{"keras": "keras.ops.nancumsum", "numpy": "numpy.nancumsum"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.nancumsum'
    fn = resolve(QNAME)
