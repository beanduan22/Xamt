"""Minimal cross-library repro for bug_052 (ceil/generic/1)."""
import importlib
import json
import os
...
APIS = json.loads(r'''{"chainer": "chainer.functions.ceil", "jax": "jax.numpy.ceil", "mindspore": "mindspore.ops.ceil"}''')
