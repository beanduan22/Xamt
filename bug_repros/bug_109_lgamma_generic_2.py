"""Minimal cross-library repro for bug_109 (lgamma/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[Infinity, Infinity, 103.97207641601562], [Infinity, 0.0, 13.815509796142578]]}''')
WRONG = json.loads(r'''{"paddle": {"dtype": "float32", "shape": [2, 3], "value": [[Infinity, Infinity, 103.2789306640625], [Infinity, 0.0, 13.815509796142578]]}}''')
APIS = json.loads(r'''{"paddle": "paddle.lgamma", "tensorflow": "tensorflow.math.lgamma"}''')
