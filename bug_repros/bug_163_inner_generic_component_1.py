"""Minimal cross-library repro for bug_163 (inner/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["jax", "keras", "mindspore", "mxnet", "numpy", "paddle", "torch"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [], "value": 0.84539794921875}''')
WRONG = json.loads(r'''{}''')
APIS = json.loads(r'''{"jax": "jax.numpy.inner", "numpy": "numpy.inner"}''')
