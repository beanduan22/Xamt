"""Minimal cross-library repro for bug_123 (angle/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["keras", "paddle", "tensorflow", "torch"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[0.0, 0.0, 0.0], [3.1415927410125732, 0.0, 0.0]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [2, 3], "value": [[3.1415927410125732, 0.0, 0.0], [3.1415927410125732, 0.0, 0.0]]}, "numpy": {"dtype": "float32", "shape": [2, 3], "value": [[3.1415927410125732, 0.0, 0.0], [3.1415927410125732, 0.0, 0.0]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.angle", "numpy": "numpy.angle", "torch": "torch.angle"}''')
