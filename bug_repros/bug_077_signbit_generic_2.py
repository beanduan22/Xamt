"""Minimal cross-library repro for bug_077 (signbit/generic/2)."""
import importlib
import json
import os
...
APIS = json.loads(r'''{"mindspore": "mindspore.numpy.signbit", "paddle": "paddle.signbit"}''')

def run_paddle():
    LIB = 'paddle'
    QNAME = 'paddle.signbit'
    fn = resolve(QNAME)
