"""Minimal cross-library repro for bug_150 (fft2/fft)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["numpy", "paddle", "scipy", "torch"]''')
EXPECTED = json.loads(r'''{"dtype": "complex64", "shape": [2, 3], "value": [[[-88.0, 0.0], [1.500000030061316e+20, 8.66025407805674e+19], [1.500000030061316e+20, -8.66025407805674e+19]], [[88.0, 0.0], [1.500000030061316e+20, 8.66025407805674e+19], [1.500000030061316e+20, -8.66025407805674e+19]]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "complex64", "shape": [2, 3], "value": [[[0.0, 0.0], [1.500000030061316e+20, 8.66025407805674e+19], [1.500000030061316e+20, -8.66025407805674e+19]], [[0.0, 0.0], [1.500000030061316e+20, 8.66025407805674e+19], [1.500000030061316e+20, -8.66025407805674e+19]]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.fft.fft2", "numpy": "numpy.fft.fft2"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.fft.fft2'
    fn = resolve(QNAME)
