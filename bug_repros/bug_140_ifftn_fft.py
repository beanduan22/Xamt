"""Minimal cross-library repro for bug_140 (ifftn/fft)."""
import importlib
import json
import os
...
APIS = json.loads(r'''{"jax": "jax.numpy.fft.ifftn", "numpy": "numpy.fft.ifftn"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.fft.ifftn'
    fn = resolve(QNAME)
