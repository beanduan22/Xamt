"""Minimal cross-library repro for bug_188 (vdot/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [], "value": 0.0}''')
WRONG = json.loads(r'''{"mxnet": {"dtype": "float32", "shape": [], "value": 1.999999761581421}}''')
APIS = json.loads(r'''{"keras": "keras.ops.vdot", "mxnet": "mxnet.numpy.vdot"}''')

def run_keras():
    LIB = 'keras'
    QNAME = 'keras.ops.vdot'
    fn = resolve(QNAME)
