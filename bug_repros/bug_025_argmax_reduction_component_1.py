"""Minimal cross-library repro for bug_025 (argmax/reduction/component/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["chainer", "mindspore", "mxnet", "numpy", "paddle", "torch"]''')
EXPECTED = json.loads(r'''{"dtype": "int32", "shape": [2], "value": [2, 1]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "int32", "shape": [2], "value": [0, 1]}, "keras": {"dtype": "int32", "shape": [2], "value": [1, 1]}, "tensorflow": {"dtype": "int64", "shape": [2], "value": [0, 1]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.argmax", "keras": "keras.ops.argmax", "numpy": "numpy.argmax", "tensorflow": "tensorflow.math.argmax"}''')
