"""Minimal cross-library repro for bug_177 (less/comparison/3)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "bool", "shape": [2, 3], "value": [[false, true, false], [true, false, false]]}''')
WRONG = json.loads(r'''{"mxnet": {"dtype": "bool", "shape": [2, 3], "value": [[false, true, false], [true, false, true]]}}''')
APIS = json.loads(r'''{"mxnet": "mxnet.numpy.less", "tensorflow": "tensorflow.math.less"}''')

def run_tensorflow():
    LIB = 'tensorflow'
    QNAME = 'tensorflow.math.less'
    fn = resolve(QNAME)
