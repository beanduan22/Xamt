"""Minimal cross-library repro for bug_038 (sort/generic/5)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, NaN], [-1.0, 9.999999974752427e-07, 1.0]]}''')
WRONG = json.loads(r'''{"mxnet": {"dtype": "float32", "shape": [2, 3], "value": [[NaN, -Infinity, Infinity], [-1.0, 9.999999974752427e-07, 1.0]]}}''')
APIS = json.loads(r'''{"mxnet": "mxnet.ndarray.sort", "numpy": "numpy.sort"}''')
