"""Minimal cross-library repro for bug_070 (nonzero/generic/3)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "int32", "shape": [3, 2], "value": [[1, 0], [1, 1], [1, 2]]}''')
WRONG = json.loads(r'''{"paddle": {"dtype": "int64", "shape": [4, 2], "value": [[0, 2], [1, 0], [1, 1], [1, 2]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.nonzero", "paddle": "paddle.nonzero"}''')
