"""Minimal cross-library repro for bug_118 (ndtri/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, Infinity, -4.753424167633057]]}''')
WRONG = json.loads(r'''{"chainer": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -14.121426582336426], [NaN, Infinity, -4.753424167633057]]}, "torch": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -14.121426582336426], [NaN, Infinity, -4.753424167633057]]}}''')
APIS = json.loads(r'''{"chainer": "chainer.functions.ndtri", "jax": "jax.scipy.special.ndtri", "torch": "torch.special.ndtri"}''')

def run_jax():
    LIB = 'jax'
    QNAME = 'jax.scipy.special.ndtri'
    fn = resolve(QNAME)
