"""Minimal cross-library repro for bug_175 (hypot/generic/2)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"keras": {"dtype": "float32", "shape": [3], "value": [NaN, NaN, 0.0]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.hypot", "keras": "keras.ops.hypot"}''')

def run_jax():
    LIB = 'jax'
    QNAME = 'jax.numpy.hypot'
    fn = resolve(QNAME)
