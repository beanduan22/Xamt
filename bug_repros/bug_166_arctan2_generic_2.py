"""Minimal cross-library repro for bug_166 (arctan2/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [3], "value": [1.5707963705062866, -1.570796251296997, 1.5707963705062866]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [3], "value": [1.5707963705062866, -1.5707963705062866, 3.1415927410125732]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.arctan2", "mindspore": "mindspore.ops.arctan2"}''')

def run_jax():
    LIB = 'jax'
    QNAME = 'jax.numpy.arctan2'
    fn = resolve(QNAME)
