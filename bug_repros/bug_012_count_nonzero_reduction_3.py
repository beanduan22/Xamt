"""Minimal cross-library repro for bug_012 (count_nonzero/reduction/3)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"jax": {"dtype": "int32", "shape": [], "value": 3}, "mindspore": {"dtype": "int32", "shape": [], "value": 3}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.count_nonzero", "mindspore": "mindspore.numpy.count_nonzero", "numpy": "numpy.count_nonzero"}''')
