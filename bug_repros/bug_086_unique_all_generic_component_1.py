"""Minimal cross-library repro for bug_086 (unique_all/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''[{"dtype": "float32", "shape": [5], "value": [-1.0, -0.0, 1.401298464324817e-45, 9.999999974752427e-07, 1.0]}, {"dtype": "int64", "shape": [5], "value": [3, 0, 2, 5, 4]}, {"dtype": "int64", "shape": [2, 3], "value": [[1, 1, 2], [0, 4, 3]]}, {"dtype": "int64", "shape": [5], "value": [1, 2, 1, 1, 1]}]''')
WRONG = json.loads(r'''{"jax": [{"dtype": "float32", "shape": [4], "value": [-1.0, -0.0, 9.999999974752427e-07, 1.0]}, {"dtype": "int32", "shape": [4], "value": [3, 0, 5, 4]}, {"dtype": "int32", "shape": [2, 3], "value": [[1, 1, 1], [0, 3, 2]]}, {"dtype": "int32", "shape": [4], "value": [1, 3, 1, 1]}]}''')
APIS = json.loads(r'''{"jax": "jax.numpy.unique_all", "numpy": "numpy.unique_all"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.unique_all'
    fn = resolve(QNAME)
