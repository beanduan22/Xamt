"""Minimal cross-library repro for bug_139 (ifft2/fft)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "complex64", "shape": [2, 3], "value": [[[NaN, 0.0], [NaN, Infinity], [NaN, -Infinity]], [[NaN, 0.0], [NaN, Infinity], [NaN, -Infinity]]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "complex64", "shape": [2, 3], "value": [[[NaN, NaN], [NaN, NaN], [NaN, NaN]], [[NaN, NaN], [NaN, NaN], [NaN, NaN]]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.fft.ifft2", "numpy": "numpy.fft.ifft2"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.fft.ifft2'
    fn = resolve(QNAME)
