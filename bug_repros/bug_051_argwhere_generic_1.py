"""Minimal cross-library repro for bug_051 (argwhere/generic/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["mxnet", "numpy", "paddle"]''')
EXPECTED = json.loads(r'''{"dtype": "int64", "shape": [4, 2], "value": [[0, 2], [1, 0], [1, 1], [1, 2]]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "int64", "shape": [3, 2], "value": [[1, 0], [1, 1], [1, 2]]}}''')
APIS = json.loads(r'''{"mindspore": "mindspore.numpy.argwhere", "numpy": "numpy.argwhere"}''')
