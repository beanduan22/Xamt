"""Minimal cross-library repro for bug_115 (log2/generic/2)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, 0.0, -19.931568145751953]]}}''')
APIS = json.loads(r'''{"mindspore": "mindspore.numpy.log2", "mxnet": "mxnet.numpy.log2"}''')

def run_mxnet():
    LIB = 'mxnet'
    QNAME = 'mxnet.numpy.log2'
    fn = resolve(QNAME)
