"""Minimal cross-library repro for bug_161 (dot/generic)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [], "value": 0.0}, "keras": {"dtype": "float32", "shape": [], "value": 0.0}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.dot", "keras": "keras.ops.dot", "numpy": "numpy.dot"}''')
