"""Minimal cross-library repro for bug_169 (max/reduction/3)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [], "value": 2.0}}''')
APIS = json.loads(r'''{"keras": "keras.ops.amax", "mindspore": "mindspore.mint.amax"}''')

def run_keras():
    LIB = 'keras'
    QNAME = 'keras.ops.amax'
    fn = resolve(QNAME)
