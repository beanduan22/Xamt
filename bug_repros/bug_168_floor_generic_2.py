"""Minimal cross-library repro for bug_168 (floor/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[9.999999680285692e+37, -9.999999680285692e+37, 0.0], [-1.0, 0.0, -0.0]]}''')
WRONG = json.loads(r'''{"tensorflow": {"dtype": "float32", "shape": [2, 3], "value": [[9.999999680285692e+37, -9.999999680285692e+37, 0.0], [-0.0, 0.0, -0.0]]}}''')
APIS = json.loads(r'''{"mxnet": "mxnet.numpy.floor", "tensorflow": "tensorflow.math.floor"}''')

def run_mxnet():
    LIB = 'mxnet'
    QNAME = 'mxnet.numpy.floor'
    fn = resolve(QNAME)
