"""Minimal cross-library repro for bug_116 (log2/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["chainer", "mxnet", "paddle", "torch"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -149.0], [NaN, 0.0, -19.931568145751953]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, 0.0, -19.931568145751953]]}, "keras": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -150.0], [NaN, 0.0, -19.931568145751953]]}, "mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, 0.0, -19.931568145751953]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.log2", "keras": "keras.ops.log2", "mindspore": "mindspore.numpy.log2", "torch": "torch.log2"}''')
