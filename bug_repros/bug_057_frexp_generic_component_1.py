"""Minimal cross-library repro for bug_057 (frexp/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''[{"dtype": "float32", "shape": [2, 3], "value": [[0.0, 0.0, 0.5], [-0.5, 0.5, 0.5242879986763]]}, {"dtype": "float32", "shape": [2, 3], "value": [[0.0, 0.0, -148.0], [1.0, 1.0, -19.0]]}]''')
WRONG = json.loads(r'''{"jax": [{"dtype": "float32", "shape": [2, 3], "value": [[-0.0, 0.0, 0.5], [-0.5, 0.5, 0.5242879986763]]}, {"dtype": "int32", "shape": [2, 3], "value": [[0, 0, -149], [1, 1, -19]]}]}''')
APIS = json.loads(r'''{"jax": "jax.numpy.frexp", "torch": "torch.frexp"}''')
