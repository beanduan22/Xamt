"""Minimal cross-library repro for bug_033 (flatnonzero/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "int64", "shape": [4], "value": [2, 3, 4, 5]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "int32", "shape": [3], "value": [3, 4, 5]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.flatnonzero", "numpy": "numpy.flatnonzero"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.flatnonzero'
    fn = resolve(QNAME)
