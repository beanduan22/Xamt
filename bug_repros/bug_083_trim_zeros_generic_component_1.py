"""Minimal cross-library repro for bug_083 (trim_zeros/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-0.0, 0.0, 1.401298464324817e-45], [-1.0, 1.0, 9.999999974752427e-07]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [1, 3], "value": [[-1.0, 1.0, 9.999999974752427e-07]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.trim_zeros", "numpy": "numpy.trim_zeros"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.trim_zeros'
    fn = resolve(QNAME)
