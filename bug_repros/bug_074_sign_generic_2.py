"""Minimal cross-library repro for bug_074 (sign/generic/2)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"tensorflow": {"dtype": "float32", "shape": [2, 3], "value": [[0.0, 0.0, 0.0], [-1.0, 1.0, 1.0]]}}''')
APIS = json.loads(r'''{"mxnet": "mxnet.numpy.sign", "tensorflow": "tensorflow.math.sign"}''')

def run_mxnet():
    LIB = 'mxnet'
    QNAME = 'mxnet.numpy.sign'
    fn = resolve(QNAME)
