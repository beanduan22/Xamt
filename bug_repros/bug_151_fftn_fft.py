"""Minimal cross-library repro for bug_151 (fftn/fft)."""
import importlib
import json
import os
...
APIS = json.loads(r'''{"jax": "jax.numpy.fft.fftn", "numpy": "numpy.fft.fftn"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.fft.fftn'
    fn = resolve(QNAME)
