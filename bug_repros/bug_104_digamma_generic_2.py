"""Minimal cross-library repro for bug_104 (digamma/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[NaN, NaN, NaN], [NaN, -0.5772159099578857, -1000000.5625]]}''')
WRONG = json.loads(r'''{"paddle": {"dtype": "float32", "shape": [2, 3], "value": [[Infinity, -Infinity, -Infinity], [NaN, -0.5772159099578857, -1000000.5625]]}}''')
APIS = json.loads(r'''{"paddle": "paddle.digamma", "tensorflow": "tensorflow.math.digamma"}''')
