"""Minimal cross-library repro for bug_132 (rankdata/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float64", "shape": [6], "value": [2.5, 2.5, 4.0, 1.0, 6.0, 5.0]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [6], "value": [3.0, 3.0, 3.0, 1.0, 6.0, 5.0]}}''')
