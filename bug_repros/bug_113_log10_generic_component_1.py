"""Minimal cross-library repro for bug_113 (log10/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -44.85346984863281], [NaN, 0.0, -6.000000476837158]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, 0.0, -6.0]]}, "keras": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -45.15449905395508], [NaN, 0.0, -6.0]]}, "mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -Infinity], [NaN, 0.0, -6.0]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.log10", "keras": "keras.ops.log10", "mindspore": "mindspore.numpy.log10", "torch": "torch.log10"}''')
