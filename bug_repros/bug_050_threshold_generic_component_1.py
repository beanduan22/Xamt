"""Minimal cross-library repro for bug_050 (threshold/generic/component/1)."""
import importlib
import json
import os
...
WRONG = json.loads(r'''{"torch": {"dtype": "float32", "shape": [2, 3], "value": [[-1.0, -1.0, 1.401298464324817e-45], [-1.0, 1.0, 9.999999974752427e-07]]}}''')
APIS = json.loads(r'''{"tensorflow": "tensorflow.keras.activations.threshold", "torch": "torch.threshold"}''')
