"""Minimal cross-library repro for bug_112 (log10/generic/2)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -44.85346984863281], [NaN, 0.0, -6.0]]}''')
WRONG = json.loads(r'''{"mindspore": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, -Infinity, -38.23080062866211], [NaN, 0.0, -6.0]]}}''')
APIS = json.loads(r'''{"mindspore": "mindspore.numpy.log10", "mxnet": "mxnet.numpy.log10"}''')

def run_mxnet():
    LIB = 'mxnet'
    QNAME = 'mxnet.numpy.log10'
    fn = resolve(QNAME)
