"""Minimal cross-library repro for bug_141 (rfft/fft)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["mindspore", "numpy", "paddle", "scipy", "torch"]''')
EXPECTED = json.loads(r'''{"dtype": "complex64", "shape": [3], "value": [[NaN, 0.0], [NaN, -Infinity], [NaN, 0.0]]}''')
WRONG = json.loads(r'''{"jax": {"dtype": "complex64", "shape": [3], "value": [[NaN, 0.0], [NaN, NaN], [NaN, 0.0]]}, "keras": {"dtype": "complex64", "shape": [3], "value": [[NaN, 0.0], [NaN, NaN], [NaN, 0.0]]}, "tensorflow": {"dtype": "complex64", "shape": [3], "value": [[NaN, 0.0], [NaN, NaN], [NaN, 0.0]]}}''')
APIS = json.loads(r'''{"jax": "jax.numpy.fft.rfft", "keras": "keras.ops.rfft", "numpy": "numpy.fft.rfft", "tensorflow": "tensorflow.signal.rfft"}''')

def run_numpy():
    LIB = 'numpy'
    QNAME = 'numpy.fft.rfft'
    fn = resolve(QNAME)
