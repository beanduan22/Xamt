"""Minimal cross-library repro for bug_011 (angle/generic/2)."""
import importlib
import json
import os
...
EXPECTED_LIBS = json.loads(r'''["jax", "numpy", "paddle"]''')
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[NaN, 0.0, 3.1415927410125732], [3.1415927410125732, 0.0, 0.0]]}''')
WRONG = json.loads(r'''{"tensorflow": {"dtype": "float32", "shape": [2, 3], "value": [[0.0, 0.0, 3.1415927410125732], [3.1415927410125732, 0.0, 0.0]]}}''')
APIS = json.loads(r'''{"numpy": "numpy.angle", "tensorflow": "tensorflow.math.angle"}''')
