"""Minimal cross-library repro for bug_120 (rsqrt/generic/component/1)."""
import importlib
import json
import os
...
EXPECTED = json.loads(r'''{"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, Infinity], [NaN, 1.0, 1000.0]]}''')
WRONG = json.loads(r'''{"chainer": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, 2.671373844909537e+22], [NaN, 1.0, 999.9999389648438]]}, "mxnet": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, 2.671373844909537e+22], [NaN, 1.0, 999.9999389648438]]}, "paddle": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, 2.671373844909537e+22], [NaN, 1.0, 999.9999389648438]]}, "torch": {"dtype": "float32", "shape": [2, 3], "value": [[-Infinity, Infinity, 2.671373844909537e+22], [NaN, 1.0, 999.9999389648438]]}}''')
APIS = json.loads(r'''{"chainer": "chainer.functions.rsqrt", "jax": "jax.lax.rsqrt", "mxnet": "mxnet.ndarray.rsqrt", "paddle": "paddle.rsqrt", "torch": "torch.rsqrt"}''')
