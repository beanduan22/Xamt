...
def test_batch_norm2d_functions(input_data):
    run_test("test_batch_norm2d", input_data, api_functions)

if __name__ == "__main__":
    test_batch_norm2d_functions()
    finalize_results("test_batch_norm2d")
